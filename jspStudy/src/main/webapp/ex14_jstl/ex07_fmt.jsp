...
<%-- /webapp/ex14_ustl/ex07_fmt.jsp --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>JSTL 형식화 태기 : parse 관련 태그</title>
</head>
<body>
<h3>Format 된 숫자를 숫자로 변경</h3>
<%-- var="num1" 속성값으로 등록됨. 화면출력안됨--%>
...
<fmt:parseDate value="2025-12-25 12:00:00" 
			   pattern="yyyy-MM-dd HH:mm:ss" var="day"/>
${day}<br>
<fmt:parseDate value="2025-12-25 12:00:00" 
			   pattern="yyyy-MM-dd HH:mm:ss"/><br>

<p>문제: 2025-12-25일의 요일 출력하기</p>
