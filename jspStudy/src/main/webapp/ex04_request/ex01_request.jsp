...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- /webapp/ex04_request/ex01_request.jsp 
...
<body>
<%
// 파라미터의 인코딩 설정. 처음에 실행햐아 함.
  request.setCharacterEncoding("UTF-8");
// name 속성만 적용된다!(id, value 등등은 적용 안됨)
...
// getParameter("파라미터이름") : 한개의 값만 조회함.
...
<table border="1">
	...
	<%--
	  Enumeration : 반복자.
	  Enumeration getParameterNames() : 파라미터 이름목록 리턴
	 --%>
