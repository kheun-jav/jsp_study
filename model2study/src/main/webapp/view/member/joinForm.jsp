...
<%--
	...
	return_input_check(this) : input_check() 함수 호출. 매개변수 this == (form 객체를 의미) 
 --%>
<form action="join" name="f" method="post" onsubmit="return input_check(this)">
	...
	<table>
		...
		<%-- href="url 정보" 
			 href="javascript:win_upload()" => javascript의 win_upload() 함수 호출
		 --%>
		<font size="1"><a href="javascript:win_upload()">사진등록</a></font>
		</td>
		<th>아이디</th>
		<td><input type="text" name="id"><button type="button" onclick="idchk()">중복검색</button>
		</td></tr>
	...
	function win_upload() {
		let op = "width=500,height=500mleft=50,top=150";
