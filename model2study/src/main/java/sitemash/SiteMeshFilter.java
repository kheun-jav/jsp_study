 ...
 * 
 * sitemesh 기능 : 화면의 layout 페이지를 구현하여 jsp 페이지를 적용하는 프레임워크
 * 
...
public class SiteMeshFilter extends ConfigurableSiteMeshFilter {
	...
	protected void applyCustomConfiguration(SiteMeshFilterBuilder builder) {
		//layout 페이지의 위치정보 설정
		// /member/* => http://localhost:8080/model1Study/member/ 의 모든 요청시
		// 				/layout/layout.jsp 페이지를 layout 페이지로 설정 
		//addDecoratorPath(url, decorator 페이지) : layout을 설정
		//addExcludePath (url) : layout 페이지를 제외
